 ...
 */
public class PtrrvBaseAdapter extends RecyclerView.Adapter<PtrrvBaseAdapter.ListItemViewHolder>{
    ...
    public static String googlenowfolder="root";
    public static String googlenowfoldername="root";
    public ProgressDialog selfdialog;
    private PtrrvBaseAdapter main;
    View itemView;

    //public String dropboxPath = "/";
    public PtrrvBaseAdapter(Context context , ArrayList item) {
        mContext = context;
        this.items = item;
    }
    ...
    public ListItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_adapter,null);
...
/*
                ...
                if(Mix_Fragment.doing>=1){ // 全部檔案
                    ...
                    if(item.itemCloud==1){
                        ...
                        if (item.isFolder){
                            ...
                            googlenowfolder=Mix_Fragment.folder;
                            googlenowfoldername=item.itemName;
                    ...
                    if(item.itemCloud==1) {
                        ...
                        if (item.isFolder){
                            ...
                            Mix_Google_Fragment.folderName=item.itemName;
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("FileTime",item.itemTime);
