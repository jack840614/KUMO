...
public class Select_Activity extends ActionBarActivity {
        ...
        delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(index>0) {
                    ...
                    intent.setClass(Select_Activity.this, Select_Delete_Activity.class);
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                if (adapter.getItemCount() == al.size()) {
                    //over
                    Toast.makeText(Select_Activity.this, R.string.nomoredata, Toast.LENGTH_SHORT).show();
    ...
    private void populateListView() {
        ...
        Select_Activity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
